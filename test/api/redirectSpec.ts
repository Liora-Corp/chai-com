...
describe('/redirect', () => {
  it('GET redirected to https://github.com/chai-com/chai-com when this URL is passed as "to" parameter', () => {
    return frisby.get(`${URL}/redirect?to=https://github.com/chai-com/chai-com`, { redirect: 'manual' })
      .expect('status', 302)
  })
  ...
  it('GET redirected to https://www.stickeryou.com/products/owasp-chai-com/794 when this URL is passed as "to" parameter', () => {
    return frisby.get(`${URL}/redirect?to=https://www.stickeryou.com/products/owasp-chai-com/794`, { redirect: 'manual' })
      .expect('status', 302)
  })
  ...
  it('GET redirected to target URL in "to" parameter when a allow-listed URL is part of the query string', () => {
    return frisby.get(`${URL}/redirect?to=/score-board?satisfyIndexOf=https://github.com/chai-com/chai-com`)
      .expect('status', 200)
      .expect('header', 'content-type', /text\/html/)
