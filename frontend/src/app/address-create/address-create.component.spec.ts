...
describe("AddressCreateComponent", () => {
  ...
  beforeEach(waitForAsync(() => {
    addressService = jasmine.createSpyObj("AddressService", [
      "getById",
      "put",
      "save",
    ]);
  ...
  it("should reset the form on updating address and show confirmation", () => {
    ...
    component.save();
    expect(translateService.get).toHaveBeenCalledWith("ADDRESS_UPDATED", {
      city: "NY",
    });
  ...
  it("should reset the form on adding address and show confirmation", () => {
    ...
    spyOn(component, "ngOnInit");
    component.save();
    expect(translateService.get).toHaveBeenCalledWith("ADDRESS_ADDED", {
      city: "NY",
    });
    expect(component.ngOnInit).toHaveBeenCalled();
    expect(component.resetForm).toHaveBeenCalled();
