...
describe("LastLoginIpComponent", () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      ...
      imports: [MatCardModule, LastLoginIpComponent, TranslateModule.forRoot()],
    }).compileComponents();
  }));
  ...
  xit("should set Last-Login IP from JWT as trusted HTML", () => {
    ...
    localStorage.setItem(
      "token",
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7Imxhc3RMb2dpbklwIjoiMS4yLjMuNCJ9fQ.RAkmdqwNypuOxv3SDjPO4xMKvd1CddKvDFYDBfUt3bg",
    );
    component.ngOnInit();
