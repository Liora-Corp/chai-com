...
describe("AboutComponent", () => {
  ...
  it("should set Twitter link as obtained from configuration", () => {
    configurationService.getApplicationConfiguration.and.returnValue(
      of({ application: { social: { twitterUrl: "TWITTER" } } }),
    );
    component.ngOnInit();
  ...
  it("should set Facebook link as obtained from configuration", () => {
    configurationService.getApplicationConfiguration.and.returnValue(
      of({ application: { social: { facebookUrl: "FACEBOOK" } } }),
    );
    component.ngOnInit();
  ...
  it("should set Slack link as obtained from configuration", () => {
    configurationService.getApplicationConfiguration.and.returnValue(
      of({ application: { social: { slackUrl: "SLACK" } } }),
    );
    component.ngOnInit();
  ...
  it("should set press kit link as obtained from configuration", () => {
    configurationService.getApplicationConfiguration.and.returnValue(
      of({ application: { social: { pressKitUrl: "PRESS_KIT" } } }),
    );
    component.ngOnInit();
  ...
  it("should set NFT link as obtained from configuration", () => {
    configurationService.getApplicationConfiguration.and.returnValue(
      of({ application: { social: { nftUrl: "NFT" } } }),
    );
    component.ngOnInit();
