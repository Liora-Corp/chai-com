...
describe("NavbarComponent", () => {
  ...
  beforeEach(waitForAsync(() => {
    administrationService = jasmine.createSpyObj("AdministrationService", [
  ...
  it("should show nothing on error retrieving application version", fakeAsync(() => {
    administrationService.getApplicationVersion.and.returnValue(
      throwError("Error"),
    );
    component.ngOnInit();
    expect(component.version).toBe("");
  ...
  it("should hide GitHub ribbon if so configured", () => {
    configurationService.getApplicationConfiguration.and.returnValue(
      of({ application: { showGitHubLinks: false } }),
    );
    component.ngOnInit();
