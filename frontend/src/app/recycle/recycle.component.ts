...
export class RecycleComponent implements OnInit {
  ...
  @ViewChild("addressComp", { static: true })
  public addressComponent: AddressComponent;
  public requestorControl: UntypedFormControl = new UntypedFormControl(
    { value: "", disabled: true },
    [],
  );
  public recycleQuantityControl: UntypedFormControl = new UntypedFormControl(
    "",
