...
describe("RegisterComponent", () => {
  ...
  beforeEach(waitForAsync(() => {
    securityAnswerService = jasmine.createSpyObj("SecurityAnswerService", [
      "save",
    ]);
  ...
  it("redirects to login page after user registration", fakeAsync(() => {
    ...
    const user = {
      ...
      securityQuestion: { id: 1, question: "Wat is?" },
      securityAnswer: "Answer",
    };
    const securityAnswerObject = {
      UserId: 1,
      answer: "Answer",
    ...
    expect(securityAnswerService.save.calls.argsFor(0)[0]).toEqual(
