...
describe("ProductDetailsComponent", () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    productReviewService = jasmine.createSpyObj("ProductReviewService", [
      "get",
      "create",
    ]);
  ...
  it("should post anonymous review if no user email is returned", () => {
    ...
    expect(productReviewService.create.calls.argsFor(0)[1]).toEqual(
      reviewObject,
    );
  });
  ...
  it("should refresh reviews after posting a review", () => {
    component.data = { productData: { id: 42 } as Product };
    productReviewService.create.and.returnValue(of({}));
    productReviewService.get.and.returnValue(
      of([{ id: "42", message: "Review 1", author: "Anonymous" }]),
    );
    userService.whoAmI.and.returnValue(of({}));
    component.ngOnInit();
    const textArea: HTMLTextAreaElement = fixture.debugElement.query(
  ...
  it("should open a modal dialog with review editor", () => {
    ...
    productReviewService.get.and.returnValue(
      of([
        { id: "42", message: "Great product!", author: "horst@juice-sh.op" },
      ]),
    );
    component.ngOnInit();
