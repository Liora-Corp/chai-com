...
describe("SidenavComponent", () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    configurationService.getApplicationConfiguration.and.returnValue(
      of({ application: { welcomeBanner: {} }, hackingInstructor: {} }),
    );
    ...
    administractionService = jasmine.createSpyObj("AdministrationService", [
  ...
  it("should hide Score Board link when Score Board was not discovered yet", () => {
    challengeService.find.and.returnValue(
      of([{ name: "Score Board", solved: false }]),
    );
  ...
  it("should show Score Board link when Score Board was already discovered", () => {
    challengeService.find.and.returnValue(
      of([{ name: "Score Board", solved: true }]),
    );
    component.getScoreBoardStatus();
