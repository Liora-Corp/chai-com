...
describe("FeedbackService", () => {
  ...
  it("should get all feedback directly from the rest api", inject(
    [FeedbackService, HttpTestingController],
  ...
  it("should delete feedback directly via the rest api", inject(
    [FeedbackService, HttpTestingController],
    fakeAsync((service: FeedbackService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should create feedback directly via the rest api", inject(
    [FeedbackService, HttpTestingController],
    fakeAsync((service: FeedbackService, httpMock: HttpTestingController) => {
      let res: any;
