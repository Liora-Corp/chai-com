...
describe("BasketService", () => {
  ...
  it("should get basket directly from the rest api", inject(
    [BasketService, HttpTestingController],
  ...
  it("should get single basket item directly from the rest api", inject(
    [BasketService, HttpTestingController],
    fakeAsync((service: BasketService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should create basket item directly from the rest api", inject(
    [BasketService, HttpTestingController],
    fakeAsync((service: BasketService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should update basket item directly from the rest api", inject(
    [BasketService, HttpTestingController],
    fakeAsync((service: BasketService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should delete basket item directly from the rest api", inject(
    [BasketService, HttpTestingController],
    fakeAsync((service: BasketService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should place order for basket via the rest api", inject(
    [BasketService, HttpTestingController],
    fakeAsync((service: BasketService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should apply coupon to basket via the rest api", inject(
    [BasketService, HttpTestingController],
    fakeAsync((service: BasketService, httpMock: HttpTestingController) => {
      let res: any;
      service.applyCoupon(1, "1234567890").subscribe((data) => (res = data));
      const req = httpMock.expectOne(
        "http://localhost:3000/rest/basket/1/coupon/1234567890",
      );
