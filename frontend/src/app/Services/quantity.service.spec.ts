...
describe("QuantityService", () => {
  ...
  it("should get all quantities directly from the rest api", inject(
    [QuantityService, HttpTestingController],
  ...
  it("should change quantity directly via the rest api", inject(
    [QuantityService, HttpTestingController],
    fakeAsync((service: QuantityService, httpMock: HttpTestingController) => {
      let res;
