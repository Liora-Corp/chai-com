...
describe("RecycleService", () => {
  ...
  it("should find the recycle directly from the rest api", inject(
    [RecycleService, HttpTestingController],
  ...
  it("should create recycle directly via the rest api", inject(
    [RecycleService, HttpTestingController],
    fakeAsync((service: RecycleService, httpMock: HttpTestingController) => {
      let res: any;
