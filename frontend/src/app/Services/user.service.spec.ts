...
describe("UserService", () => {
  ...
  it("should get all users directly from the rest api", inject(
  ...
  it("should get single users directly from the rest api", inject(
    [UserService, HttpTestingController],
    fakeAsync((service: UserService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should create user directly via the rest api", inject(
    [UserService, HttpTestingController],
    fakeAsync((service: UserService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should login user directly via the rest api", inject(
    [UserService, HttpTestingController],
    fakeAsync((service: UserService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should change user password directly via the rest api", inject(
    [UserService, HttpTestingController],
    fakeAsync((service: UserService, httpMock: HttpTestingController) => {
      let res: any;
      service
        .changePassword({ current: "foo", new: "bar", repeat: "bar" })
        .subscribe((data) => (res = data));

      const req = httpMock.expectOne(
        "http://localhost:3000/rest/user/change-password?current=foo&new=bar&repeat=bar",
      );
  ...
  it("should return the logged-in users identity directly from the rest api", inject(
    [UserService, HttpTestingController],
    fakeAsync((service: UserService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should reset the password directly from the rest api", inject(
    [UserService, HttpTestingController],
    fakeAsync((service: UserService, httpMock: HttpTestingController) => {
      let res: any;
  ...
  it("should get users deluxe status directly from the rest api", inject(
    [UserService, HttpTestingController],
    fakeAsync((service: UserService, httpMock: HttpTestingController) => {
      let res;
  ...
  it("should upgrade users deluxe status directly from the rest api", inject(
    [UserService, HttpTestingController],
    fakeAsync((service: UserService, httpMock: HttpTestingController) => {
      let res;
