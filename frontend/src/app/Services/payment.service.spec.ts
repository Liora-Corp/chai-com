...
describe("PaymentService", () => {
  ...
  it("should get single payment card directly from the api", inject(
    [PaymentService, HttpTestingController],
    fakeAsync((service: PaymentService, httpMock: HttpTestingController) => {
      let res;
  ...
  it("should create payment card directly from the api", inject(
    [PaymentService, HttpTestingController],
    fakeAsync((service: PaymentService, httpMock: HttpTestingController) => {
      let res;
  ...
  it("should delete payment card directly from the api", inject(
    [PaymentService, HttpTestingController],
    fakeAsync((service: PaymentService, httpMock: HttpTestingController) => {
      let res;
