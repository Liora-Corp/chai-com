...
describe("WalletService", () => {
  ...
  it("should get wallet balance directly from the api", inject(
    [WalletService, HttpTestingController],
  ...
  it("should update wallet balance directly from the api", inject(
    [WalletService, HttpTestingController],
    fakeAsync((service: WalletService, httpMock: HttpTestingController) => {
      let res;
