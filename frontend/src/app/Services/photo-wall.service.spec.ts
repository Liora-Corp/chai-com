...
describe("PhotoWallService", () => {
  ...
  it("should get memories directly from the api", inject(
    [PhotoWallService, HttpTestingController],
  ...
  it("should create memories directly from the api", inject(
    [PhotoWallService, HttpTestingController],
    fakeAsync((service: PhotoWallService, httpMock: HttpTestingController) => {
      let res;
      service
        .addMemory("str", new File([""], "image"))
