...
describe("ConfigurationService", () => {
  ...
  it("should get application configuration directly from the rest api", inject(
  ...
  it("should throw an error on recieving an error from the server", inject(
    [ConfigurationService, HttpTestingController],
    fakeAsync(
      (service: ConfigurationService, httpMock: HttpTestingController) => {
        let res: any;
        ...
        req.error(new ErrorEvent("Request failed"), {
          status: 404,
