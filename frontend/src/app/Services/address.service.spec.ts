...
describe("AddressService", () => {
  ...
  it("should get address directly from the api", inject(
    [AddressService, HttpTestingController],
  ...
  it("should get single address directly from the api", inject(
    [AddressService, HttpTestingController],
    fakeAsync((service: AddressService, httpMock: HttpTestingController) => {
      let res;
  ...
  it("should create address directly from the api", inject(
    [AddressService, HttpTestingController],
    fakeAsync((service: AddressService, httpMock: HttpTestingController) => {
      let res;
  ...
  it("should delete address directly from the api", inject(
    [AddressService, HttpTestingController],
    fakeAsync((service: AddressService, httpMock: HttpTestingController) => {
      let res;
