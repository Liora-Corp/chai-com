/*
 * Copyright (c) 2014-2024 Bjoern Kimminich & the WowChai-Com contributors.
...
export const ExposedCredentialsInstruction: ChallengeInstruction = {
  ...
  hints: [
    {
      text: "To start this challenge, you will have to log out first.",
      fixture: "#navbarAccount",
      unskippable: true,
      resolved: waitForLogOut(),
    },
    {
      text: "As the challenge suggests, let us have a look at the client-side code. Open the dev tools.",
      fixture: "app-navbar",
      fixtureAfter: true,
      unskippable: true,
    ...
    {
      text: "Go to Sources, and then inspect the main.js file. This is where all the client-side code is.",
      fixture: "app-navbar",
      resolved: waitInMs(10000),
    },
    {
      text: "Now, why not search for some common words related to credentials? Maybe try password, pw, or username.",
      fixture: "app-navbar",
      resolved: waitInMs(35000),
    },
    {
      text: "Once you found the hardcoded credentials, go to the login page.",
      fixture: "app-navbar",
    ...
    },
    {
      ...
      fixture: "#email",
      unskippable: true,
      resolved: waitForInputToHaveValue("#email", "testing@juice-sh.op", {
    ...
    {
      text: "🎉 Congratulations! You have been logged in with exposed credentials!",
      fixture: "app-navbar",
