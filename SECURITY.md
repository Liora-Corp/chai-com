...
WowChai-Com is a modern e-commerce web application. We take security seriously and follow the proposed Internet
standard <https://securitytxt.org> so you can find our security policy in any running instance of the application
at the expected location described in <https://tools.ietf.org/html/draft-foudil-securitytxt-06>.
